...
public class JwtUtils {
    ...
    private final String SECRET_KEY_BASE64 = "gus2ptq4Q8g0hEbq9XgKRWccuAKxrvJj9iG5qLavAi0=";
    ...
    // Generate JWT token with roles as strings
    public String generateToken(UserDetails userDetails) {
        Map<String, Object> claims = new HashMap<>();
        List<String> roles = userDetails.getAuthorities().stream()
                .map(auth -> auth.getAuthority()) // e.g., "ROLE_PATIENT"
                .toList();
